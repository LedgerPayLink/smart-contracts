...
contract LedgerPayLink is Pay {
    event LPL_PaidWithETH(
        string indexed paymentId,
        uint256 ETHAmount,
        address destination
    );

    event LPL_PaidWithToken(
        string indexed paymentId,
    ...
    constructor(
        address payable _LPLAddress,
        uint256 ledgerPayLinkFeePer1000
    ...
    // TODO add functions to swap and pay
}
